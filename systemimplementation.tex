...
At its current prototypical state Discovery Service makes certain assumptions about the current usable physical hosts in the cluster.
Namely hosts are assumed to have Linux as an operating system and 